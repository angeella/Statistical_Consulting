...
The pandemic has resulted in the largest amount of shutdowns/lockdowns worldwide at the same time in history.
>>>>>>> 8b4cb2d76144d0bd73983591a7b5a83cfb7ad6b3
...
We will transform these two first economic variables as continous variables using the Principal Component Analysis, in order to diminuish the number of covariates inside the model, having $9$ ordinal policies lockdown covariates.
